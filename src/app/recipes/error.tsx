    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-10">
        <div className="text-center py-16 px-4">
          ...
          <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200">Error loading recipes</h2>
          <p className="mb-8 text-gray-600 dark:text-gray-400 max-w-md mx-auto">
            There was a problem fetching recipes. This might be due to API limits, network issues, or an invalid API key.
          </p>
